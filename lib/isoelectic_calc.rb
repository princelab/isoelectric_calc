...
def calc_PI(pep_charges)
	pH = 6.5; pH_prev = 0.0; pH_next = 14.0
...
pis = Rserve::DataFrame.from_structs(pepcharges)

#pis = rserve_input_hash.to_dataframe
#p pepcharges.last
p robject.converse( pi_values: pis ) {	"pi_values$pi" }
robject.converse do 
...
#pdf(file="/home/ryanmt/Dropbox/coding/isoelectric_calc_and_hist/histogram.pdf", height=9, width=16)
